...
I assume that each character has an associated weight equal to the number of times the character occurs in a file,
When compressing a file I'll need to calculate these weights.
...
So, I check if the size of the bits string is multiple of 8 or not by checking the modulo of 8. Using that modulo value I can calculate the number of bits that need to be padded and handle them correctly. 
